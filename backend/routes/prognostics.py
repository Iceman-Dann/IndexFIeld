...
async def serve_prognostics_page(request: Request):
    """Serve the prognostics page using Jinja2 templates."""
    return templates.TemplateResponse("prognostics-view.html", {"request": request})
